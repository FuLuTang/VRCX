...
- :bar_chart: **个人简介——状态分布图 (Status Distribution)**
    - 在好友信息卡片中新增状态分布横轴折线图，直观展示好友在各种隐私状态下的时间占比。
...
- :chart_with_upwards_trend: **好友热力图 & 状态图表**
    - 紧跟上游，支持新版 VRCX 的所有高级图表。

- :pencil2: **信息抓取补全 (System Tools)**
    - **个人简介存档**：批量拉取并保存所有好友当前的个人简介，适合新设备/重新登录使用时一键存档，配合 Bio Diff 功能使用。
    - **隐私状态刷新**：批量抓取好友当前的隐私状态（灯色），更新到数据库，解决灯色数据统计/计算问题。
    - 支持逐项单独执行，也支持"全部抓取"一键完成。
